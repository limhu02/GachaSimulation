...
<div class="container">
    <h3>아이템 박스 등록 (관리자 전용)</h3>

    <form:form action="../item/BoxinputResult.html" method="post" enctype="multipart/form-data" modelAttribute="itemBox" >
        <table>
            <tr>
                <th>박스 코드</th>
                <td>
                ...
                <td>
                    <form:select path="game">
                        <c:forEach var="game" items="${gamelist}">
                            <form:option value="${game.name}">${game.name}</form:option>
                        </c:forEach>
                    </form:select>
                </td>
            </tr>
            <tr>
                <th>비용</th>
                <td>
                    <form:input path="price" cssClass="small-input" />
                    <div class="error-text"><form:errors path="price" /></div>
                </td>
            </tr>
        </table>
