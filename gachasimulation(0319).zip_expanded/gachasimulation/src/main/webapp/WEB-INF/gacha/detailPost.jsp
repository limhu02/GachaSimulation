...
<div class="post-container">
    <form id="postForm" action="/board/updatePost.html" method="post" enctype="multipart/form-data">
        ...
        <!-- ✅ 수정 및 삭제 버튼 -->
        <div class="buttons">
            <c:if test="${sessionScope.user_id == post.writerId || sessionScope.user_id == 'admin'}">
            ...
            <c:forEach var="comment" items="${comment}">
                <div class="comment">
                    <div class="comment-header">
                        <strong>
                            <c:choose>
                                <c:when test="${not empty comment.writer}">
                                    ${comment.writer}
                                </c:when>
                                <c:otherwise>알 수 없는 사용자</c:otherwise>
                            </c:choose>
                        </strong>
                    ...
                    <div class="comment-actions">
                    	<c:if test="${sessionScope.user_id == comment.writer || sessionScope.user_id=='admin'}">
